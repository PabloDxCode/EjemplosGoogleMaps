...
public class Constanst {
    ...
    static final LatLng QUERETARO = new LatLng(20.5872194, -100.387161);

    //Colonia Candiles

    static final LatLng CANDILES = new LatLng(20.54239332474649,-100.39992112666368);
    static final LatLng[] CANDILES_COORDS = new LatLng[]{
